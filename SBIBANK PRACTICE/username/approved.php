...
<body>
  ...
  <div class="main-content">
    <h2 style="text-align:center;">Approve user account</h2>
    <table>
      <tr>
        <th>Account</th>
        <th>Username</th>
      ...
      <?php
      $sql = "SELECT * FROM useraccount WHERE isactive=0";
      ...
      if(mysqli_num_rows($result) > 0){
          while($row = mysqli_fetch_assoc($result)){
              ...
              echo "<td><a href='activate.php?id=$row[accountno]' class='action-btn'>Activate</a></td>"; // example action button
              echo "</tr>";
          }
      } else {
